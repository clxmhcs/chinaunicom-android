...
class UnicomIntegralClientTest {
    ...
    fun overviewUsesFrozenEndpointsFormsHeadersAndParserMapping() {
        ...
        assertEquals(UnicomClientProfile.h5UserAgent("18.7"), balance.headers["User-Agent"])
        assertTrue(balance.headers["User-Agent"].orEmpty().contains("iphone_c@12.1500"))
        assertTrue(balance.headers["User-Agent"].orEmpty().contains("OSVersion/18.7"))
