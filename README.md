...
M5-C Password Login + Risk Captcha is `PASS / CLOSED`:
...
- password-specific RSA error classification, password-rejected, SMS-verification-required and generic server failures remain distinct;
...
- latest implementation-head M1/M2/M3/M4/M5 workflows all passed.
